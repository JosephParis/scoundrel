...
export const BOONS = {
  ...
  stoic: {
    id: 'stoic',
    name: 'Stoic',
    description: "From the next descent on: Max HP +10, and you no longer heal between descents.",
    example: 'The descent you take it on is unchanged. After that, end at 12 HP and the next begins at 12, not full.',
    tag: 'build',
