 ...
 * rejected: the run is real analytics either way, and the board lists only runs
 * that carry a handle, so dropping the name is exactly "keep the data, keep it
 * off the public page". Rejecting the POST would lose the run and tell the
